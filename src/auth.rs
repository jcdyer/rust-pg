...
pub fn build_md5_hash(user: &str, password: &str, salt: &str) -> String {
...
mod tests {
    ...
    #[test]
    fn test_md5_hash() {
        assert_eq!(build_md5_hash("", "", "abcd"), "md5743b08b8561cc75c4f899c35d6c3c3eb");
    }
}
